...
function actionLogin() {
	if (document.loginForm.id.value =="") {
    	...
    	/* if (userSe != "ENT"){
    		document.loginForm.action="<c:url value='/uat/uia/actionLogin2.do'/>";
    	} else { */
...
function fnInit() {
    ...
    **************************** */
    ...
    //document.getElementById('typeGnr').className = "on";
	//document.loginForm.userSe.value = "GNR";
    
    parent._top.location.reload();
    getid(document.loginForm);
...
/* function actionFirn(){
	//location.href="/uat/uia/actionFirn.do";
	document.loginForm.action="<c:url value='/uat/uia/actionFirn.do'/>";
	document.loginForm.submit();
} */
...
<div class="login_form">
	...
	<fieldset>
		...
		<%-- <div class="login_type">
			<ul id="ulLoginType" align="center">
				<li><a href="javascript:fnLoginTypeSelect('typeUsr');" id="typeUsr" title=""><spring:message code="comUatUia.loginForm.GNR"/></a></li> <!-- 업무 -->
				<li><a href="javascript:fnLoginTypeSelect('typeGnr');" id="typeGnr" title=""><spring:message code="comUatUia.loginForm.USR"/></a></li> <!-- 일반 -->
		...
		<div class="login_input">
			<ul>
				...
				<li>
						...
						<%-- <li>
							<input type="button" class="btn_login" value="<spring:message code="comUatUia.loginForm.frin"/>" onclick="actionFirn()">
						</li> --%>
