...
<div class="wTableFrm">
	...
	<tbody>
		...
		<tr>
			...
			<td class="left">
				<form:radiobuttons style="margin:0px 4px;" path="bbsTyCode" items="${bbsTyCode}" itemValue="code" itemLabel="codeNm"/>
		...
		<tr>
			...
			<td class="left">
				<form:radiobutton path="replyPosblAt" value="Y" label="예"></form:radiobutton>
				<form:radiobutton path="replyPosblAt" value="N" label="아니오"></form:radiobutton>
		...
		<tr>
			...
			<td class="left">
				<form:radiobutton path="fileAtchPosblAt" value="Y" label="예"></form:radiobutton>
				<form:radiobutton path="fileAtchPosblAt" value="N" label="아니오"></form:radiobutton>
				<div><form:errors path="fileAtchPosblAt" cssClass="error" /></div>     
			</td>
		</tr>
		
		<!-- 인쇄가능여부 -->
		<c:set var="title"><spring:message code="comCopBbs.boardMasterVO.regist.printPosblAt"/> </c:set>
		<tr>
			<th><label for="printPosblAt">${title} <span class="pilsu">*</span></label></th>
			<td class="left">
				<form:radiobutton path="printPosblAt" value="Y" label="예"></form:radiobutton>
				<form:radiobutton path="printPosblAt" value="N" label="아니오"></form:radiobutton>
				<div><form:errors path="printPosblAt" cssClass="error" /></div>     
			</td>
		</tr>
