...
function fn_print(){
	...
	// css 삽입
	   PrintPage.document.write("<link type=\"text/css\" rel=\"stylesheet\" href=\"<c:url value='/css/egovframework/com/com.css' />\">");
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<c:if test="${result.ntcrId == loginVO.id || loginVO.userSe == 'USR'}">
		<!-- 익명글 수정/삭제 불가  -->
		...
		<input class="s_submit" type="button" value="<spring:message code="button.print" />" onclick="fn_print()" style="float:left; margin:0 0 0 3px;"/>
	</div>
