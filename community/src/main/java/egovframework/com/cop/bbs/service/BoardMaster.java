...
public class BoardMaster implements Serializable {
    ...
    /**
     * printPosblAt attribute를 리턴한다.
     * 
     * @return the printPosblAt
     */
    public String getprintPosblAt() {
	return printPosblAt;
    }

    /**
     * printPosblAt attribute 값을 설정한다.
     * 
     * @param printPosblAt
     *            the printPosblAt to set
     */
    public void setprintPosblAt(String printPosblAt) {
	this.printPosblAt = printPosblAt;
    }
