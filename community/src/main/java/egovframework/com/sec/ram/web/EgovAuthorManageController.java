...
public class EgovAuthorManageController {
	 ...
	 * @exception Exception
	 */
    @IncludedInfo(name="권한관리Test", listUrl="/sec/ram/EgovAuthorListTest.do", order = 61,gid = 21)
    @RequestMapping(value="/sec/ram/EgovAuthorListTest.do")
    public String selectAuthorListTest(@ModelAttribute("authorManageVO") AuthorManageVO authorManageVO, 
    		                        ModelMap model)
            throws Exception {
    	authorManageVO.setAuthorManageList(egovAuthorManageService.selectAuthorList(authorManageVO));
    	System.out.println("여기여기" + authorManageVO);
        ...
        return "egovframework/com/sec/ram/EgovAuthorManageTest";
    } 
